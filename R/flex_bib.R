#' @title flex_bib
#'
#' @description Creates new output bib files that only contain the cited
#'    works within predefined reference sections
#'
#' @param rmarkdown_file RMarkdown file in which bibliography shall be inserted
#' @param bib_input A vector of two bib files
#' @param bib_output Name of the newly created partial .bib files
#'
#' @return Newly created partial .bib files
#'
#' @export
#' @importFrom bib2df dplyr stringr "%>%"
